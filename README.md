...
the advantage of the seekable format shows when you only want to decompress only a part of the
archive.
...
to force printing to stdout, since we know that this is only text data.
